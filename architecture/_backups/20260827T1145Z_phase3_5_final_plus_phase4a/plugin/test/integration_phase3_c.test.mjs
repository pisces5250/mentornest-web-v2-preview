...
test.after(async () => {
  // Clean up per-test-student evidence/mastery/curriculum/backfill artifacts.
  // Production ledgers (student_001/002) are NOT touched here.
  for (const s of [TEST_STUDENT_C]) {
