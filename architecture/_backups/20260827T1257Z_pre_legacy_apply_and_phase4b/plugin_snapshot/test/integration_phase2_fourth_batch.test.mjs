...
test("plugin loads with 116 tools (Phase 2 baseline 43 + Phase 3-B Chinese 11 + Phase 3-A Math 11 + Phase 3-C English 16 + Phase 3-D Science 11 + Phase 3-E Social Studies 13 + Phase 3-F Unified Contract 11)", async () => {
  await loadTools();
