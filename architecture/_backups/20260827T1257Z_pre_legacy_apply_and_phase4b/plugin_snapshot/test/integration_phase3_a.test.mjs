...
test.after(async () => {
  // Clean up per-test-student artifacts so subsequent runs start from a clean slate.
  // Production invariants (student_001/002 ledgers) are NOT touched here.
  for (const s of [TEST_STUDENT_A, TEST_STUDENT_B]) {
